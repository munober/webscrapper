...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.bottom_buttons.setStandardButtons(QtWidgets.QDialogButtonBox.Abort|QtWidgets.QDialogButtonBox.Help|QtWidgets.QDialogButtonBox.Ok|QtWidgets.QDialogButtonBox.RestoreDefaults|QtWidgets.QDialogButtonBox.Save)
        self.bottom_buttons.setCenterButtons(False)
        self.bottom_buttons.setObjectName("bottom_buttons")
        self.progressBar = QtWidgets.QProgressBar(Dialog)
        self.progressBar.setGeometry(QtCore.QRect(20, 330, 118, 23))
        ...
        self.sample_size_3 = QtWidgets.QSpinBox(self.manual)
        self.sample_size_3.setGeometry(QtCore.QRect(160, 110, 42, 22))
        self.sample_size_3.setObjectName("sample_size_3")
        ...
        self.sample_size_2 = QtWidgets.QSpinBox(self.listsearch)
        self.sample_size_2.setGeometry(QtCore.QRect(80, 60, 42, 22))
        self.sample_size_2.setObjectName("sample_size_2")
        ...
        self.sample_size = QtWidgets.QSpinBox(self.listsearch)
        self.sample_size.setGeometry(QtCore.QRect(160, 110, 42, 22))
        ...
        self.run_filter.setGeometry(QtCore.QRect(20, 130, 75, 23))
        ...
        self.height.setGeometry(QtCore.QRect(110, 30, 42, 22))
        self.height.setObjectName("height")
        self.width = QtWidgets.QSpinBox(self.preprocesses)
        self.width.setGeometry(QtCore.QRect(10, 30, 42, 22))
        ...
        self.run_prep.setGeometry(QtCore.QRect(10, 130, 75, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.manual_search_term.setPlainText(_translate("Dialog", "Margot Robbie"))
